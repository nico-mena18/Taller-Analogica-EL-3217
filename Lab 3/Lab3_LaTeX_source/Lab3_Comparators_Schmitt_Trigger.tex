...
\begin{enumerate}[label=\arabic*.]
    ...
    Sí, ya que la función de transferencia es la salida $V_{out}$ en función de $V_{in}$, sin considerar la variable temporal. Si una onda triangular y otra sinusoidal, y tienen la misma amplitud, entonces veríamos la misma función de transferencia.
