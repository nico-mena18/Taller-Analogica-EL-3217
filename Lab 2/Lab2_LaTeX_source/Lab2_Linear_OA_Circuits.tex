...
\> Mattio Coghi Quirós \> 2023 \\[0.6cm]
\> Nicolás Mena Valerio \> 2022
\end{tabbing}
...
\hline
 $10$ k$\Omega$& $1$ k$\Omega$ & $500\,\text{mV}_{pp}$ & $11$ & $5.5$ Vpp & $5.56$ Vpp & $556$ mV  & $69.2$ mVrms \\[1.2em]
\hline
\end{tabular}%
}	
\end{table}
...
Measured & Measured & Measured & Computed & Computed (pin 6) & Measured (pin 6) & Measured (pin 2) & Measured \\
\hline
 10 \text{ k}$\Omega$ & $1\text{ k}\Omega$ & $50\,\text{mV}_{pp}$ & $-10$ & $5$ V & $4.48$ V & $4.39$ mV & $87.29$ V \\[1.2em]
\hline
\end{tabular}%
}
\end{table}
...
El error es grande y además es un factor casi constante, la lectura sale $1.469$ veces el valor patrón. Un corrimiento de escala parejo como ese apunta al punto de calibración, porque si el potenciómetro no quedó exactamente en los $100\,\text{mV}$ con el resistor de $10\,\text{k}\Omega$, todas las lecturas se desplazan en la misma proporción. Lo otro que conviene revisar es que $14.63\,\text{V}$ está muy cerca de la alimentación de $15\,\text{V}$, ya en el límite de excursión de salida del 741C, donde la tensión deja de seguir de forma lineal a $R_x$.
